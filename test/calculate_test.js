...
describe("histogram get ordered data", function() {
  it("return bardata", function() {
    ...
    var numberOfBars = 6;
    var barWidth = 20;
    var barData = Statistics.generateHistogramData(sortedData, start, end, numberOfBars, barWidth);
...
describe("histogram get bars", function() {
  it("return bardata", function() {
    ...
    var end   = 86;
    var bars = 10;
    var barData = Statistics.getHistogramBars(start, end, bars);
...
describe("find absolute bar width", function() {
  it("return 10", function() {
    ...
    var bars = 8;
    var barWidth = Statistics.calcHistogramBarWidth(startingNumber, largestNumber, bars);
    expect(barWidth).toEqual(10);
  })
  it("return 10", function() {
...
it("small set", function() {
  var largestNumber = Statistics.findLargestNumber([12,14,57,99]);
...
describe("find starting number for histogram", function() {
  it("no digits", function() {
    var histogramStartingNumber = Statistics.findHistogramStartingNumber(12, 1);
    expect(histogramStartingNumber).toEqual(11.5);
  })
  it("one digit", function() {
    var histogramStartingNumber = Statistics.findHistogramStartingNumber(12.5, 2);
    expect(histogramStartingNumber).toEqual(12.45);
  })
  it("two digits", function() {
    var histogramStartingNumber = Statistics.findHistogramStartingNumber(12.5, 3);
...
describe("find significant digit for histogram", function() {
  it("real numbers", function() {
    var significantDigitLength = Statistics.findSignificantDigitLength([17.8,59,92.7,12.5,100]);
    expect(significantDigitLength).toEqual(1);
  })
  it("natural numbers", function() {
    var significantDigitLength = Statistics.findSignificantDigitLength([17,59,92,12,100]);
...
describe("find smallest number in set", function() {
  it("find smallest number inset", function() {
    var smallest = Statistics.findSmallestNumber([62.8,59.5,92.8]);
    expect(smallest).toEqual(59.5);
  })
  it("find smallest number in set", function() {
    var smallest = Statistics.findSmallestNumber([47,51,54.2,64,92.7,12.5,100,17.8,23,27,31,31.6,36]);
...
describe("calculate relative frequency from frequency table", function() {
  it("relative RF, small set", function() {
    var rf = Statistics.calcRelativeFrequencyFromTable({1:9,2:1}, 10);
...
it("relative RF, small set", function() {
  var rf = Statistics.calcRelativeFrequencyFromRaw([1,1,1,1,1,1,1,1,1,2]);
  expect(rf[1]).toEqual(0.9);
  expect(rf[2]).toEqual(0.1);
})
})
...
* Frequency Table
*/
describe("frequencycount", function() {
  it("simple multiple values", function() {
